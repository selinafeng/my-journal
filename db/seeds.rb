...
# Journal.create!(title: 'What the health?', date: Date.new(2017, 01, 02), entry: 'I tried to run today! Not a good idea...')
# Journal.create!(title: 'grocery shopping', date: Date.new(2017, 01, 01), entry: 'New year new me!')
# Journal.create!(title: 'grocery shopping', date: Date.new(2017, 01, 01), entry: 'New year new me!')
# Journal.create!(title: 'grocery shopping', date: Date.new(2017, 01, 01), entry: 'New year new me!')